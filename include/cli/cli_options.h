...
enum {
    ...
    OPT_TRACE, OPT_TRACE_MAX, OPT_TRACE_RING, OPT_CYCLE_TRACE, OPT_CYCLE_TRACE_MAX, OPT_CPU_MICROSEQ, OPT_CPU_LEGACY, OPT_PROFILE, OPT_ROM_INFO, OPT_SERIAL, OPT_SERIAL_V23,
