...
enum {
    ...
    OPT_TRACE, OPT_TRACE_MAX, OPT_TRACE_RING, OPT_CYCLE_TRACE, OPT_CYCLE_TRACE_MAX, OPT_CPU_MICROSEQ, OPT_CPU_LEGACY, OPT_ULA_CYCLE, OPT_ULA_LINE, OPT_ULA_FETCH_OFFSET, OPT_PROFILE, OPT_ROM_INFO, OPT_SERIAL, OPT_SERIAL_V23,
    ...
    OPT_LOCI_SERVE_TIMING, OPT_LOCI_SERVE_JITTER, OPT_LOCI_EMU, OPT_LOCI_EMU_USB_IMAGE, OPT_LOCI_EMU_CDC, OPT_LOCI_EMU_FLASH, OPT_LOCI_HW, OPT_LOCI_MENU_AT,
    ...
    OPT_EXPORT_BORDER, OPT_REALTIME, OPT_DISK_CREATE, OPT_BAD_SECTOR, OPT_FDC_TIMING, OPT_DISK_WRITE_PROTECT,
    OPT_LOCI_USB, OPT_TAPE_SIGNAL, OPT_TAPE_SIGNAL_FREE, OPT_HTTP_API, OPT_HTTP_API_BIND, OPT_HTTP_API_ROOT,
    OPT_ULA_NG_POKE, OPT_PSG_TRACE, OPT_KBD_TRACE, OPT_AUDIO_WAV, OPT_SCREENSHOT_TEXT,
...
static const struct option long_options[] = {
    ...
    {"screenshot-when",     required_argument, 0, OPT_SCREENSHOT_WHEN},
    {"screenshot-text-when",required_argument, 0, OPT_SCREENSHOT_TEXT_WHEN},
    ...
    {"cpu-microseq",        no_argument,       0, OPT_CPU_MICROSEQ},
    {"cpu-legacy",          no_argument,       0, OPT_CPU_LEGACY},
    {"ula-cycle",           no_argument,       0, OPT_ULA_CYCLE},
    {"ula-line",            no_argument,       0, OPT_ULA_LINE},
    {"ula-fetch-offset",    required_argument, 0, OPT_ULA_FETCH_OFFSET},
    {"cycle-trace",         required_argument, 0, OPT_CYCLE_TRACE},
    {"cycle-trace-max",     required_argument, 0, OPT_CYCLE_TRACE_MAX},
    {"trace-ring",          required_argument, 0, OPT_TRACE_RING},
    ...
    {"disk-write-protect",  no_argument,       0, OPT_DISK_WRITE_PROTECT},
    ...
    {"loci-hw",             required_argument, 0, OPT_LOCI_HW},
    ...
    {"loci-serve-timing",   required_argument, 0, OPT_LOCI_SERVE_TIMING},
    {"loci-serve-jitter",   required_argument, 0, OPT_LOCI_SERVE_JITTER},
    {"loci-menu-at",        required_argument, 0, OPT_LOCI_MENU_AT},
